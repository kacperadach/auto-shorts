...
class TASED_v2(nn.Module):
    def __init__(self):
        ...
        self.maxm2 = nn.MaxPool3d(
            kernel_size=(4, 1, 1), stride=(4, 1, 1), padding=(0, 0, 0)
        )
        self.maxt2 = nn.MaxPool3d(
            kernel_size=(1, 3, 3),
            stride=(1, 2, 2),
            padding=(0, 1, 1),
            return_indices=True,
        ...
        self.maxm3 = nn.MaxPool3d(
            kernel_size=(4, 1, 1), stride=(4, 1, 1), padding=(0, 0, 0)
        )
        self.maxt3 = nn.MaxPool3d(
            kernel_size=(1, 3, 3),
            stride=(1, 2, 2),
            padding=(0, 1, 1),
            return_indices=True,

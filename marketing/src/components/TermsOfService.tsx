export default function TermsOfService() {
  return (
    <div className="flex justify-center w-full my-8">
      <div className="prose" style={{ width: "50%" }}>
        ...
        <div>
          ...
          <div>
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                We are <strong>AutoRepurpose</strong> ("
                <strong>Company</strong>," "<strong>we</strong>," "
                <strong>us</strong>," "<strong>our</strong>" ), a company
                registered in <strong>Massachusetts</strong>,{" "}
                <strong>United States</strong> at 8 Cutter Park Somerville
              </span>
              <div />
              <div />, <div>MA</div>
          ...
          <div style={{ textAlign: "left" }}>
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                <span style={{ color: "rgb(0, 58, 250)" }}>
                  <div>app.AutoRepurpose.com</div>
                </span>{" "}
                (the <div />"<strong>Site</strong>"
                <div className="statement-end-if-in-editor" />)
                <div />
                <div />, as well as any other related products and services that
                refer or link to these legal terms (the <div />"
                <strong>Legal Terms</strong>"
                <div className="statement-end-if-in-editor" />) (collectively,
                the <div />"<strong>Services</strong>"
                <div className="statement-end-if-in-editor" />
                ).
                <div />
              </span>
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                You can contact us by <div />
                phone at <div>5084797841</div>, email at{" "}
                <div>kacperadach@gmail.com</div>
                <div />,
                <div className="statement-end-if-in-editor" /> or by mail to{" "}
                <div>8 Cutter Park</div>
                <div />, <div>Somerville</div>
                <div />
                <div />, <div>MA</div>
                <div className="statement-end-if-in-editor" />
                <div />
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                <div className="statement-end-if-in-editor" />
                ), and <div>AutoRepurpose</div>, concerning your access to and
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                you about any changes by updating the <div />
                "Last updated"
                <div className="statement-end-if-in-editor" /> date of these
          ...
          <div style={{ textAlign: "left" }}>
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                <div />
                "AS IS"
                <div className="statement-end-if-in-editor" /> for your <div />
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              <span style={{ fontSize: 15 }}>
                ...
                grant you a non-exclusive, non-transferable, revocable <div />
                license
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                <div>kacperadach@gmail.com</div>. If we ever grant you the
          ...
          <div style={{ textAlign: "left" }}>
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: 15 }}>
                Please review this section and the <div />"
                <div className="statement-end-if-in-editor" />
                <a data-custom-class="link" href="#prohibited">
                  <span style={{ color: "rgb(0, 58, 250)" }}>
                    PROHIBITED ACTIVITIES
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: 15 }}>
                ...
                <div /> through any part of the Services
                <div /> you:
              </span>
            </div>
            <ul>
              <li style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: 15 }}>
                  confirm that you have read and agree with our <div />"
                  <div className="statement-end-if-in-editor" />
                </span>
                <a data-custom-class="link" href="#prohibited">
                  <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
                ...
                <span style={{ fontSize: 15 }}>
                  ...
                  any Submission
                  <div /> that is illegal, harassing, hateful, harmful,
              ...
              <li style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: 15 }}>
                  ...
                  <div /> are original to you or that you have the necessary
                  rights and <div />
                  licenses
                  <div className="statement-end-if-in-editor" /> to submit such
                  Submissions
                  <div /> and that you have full authority to grant us the
              ...
              <li style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: 15 }}>
                  ...
                  <div /> do not constitute confidential information.
                </span>
              </li>
            </ul>
            <div style={{ lineHeight: "1.5" }}>
              You are solely responsible for your Submissions
              <div /> and you expressly agree to reimburse us for any and all
          ...
          <div style={{ textAlign: "left" }}>
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                <span style={{ color: "rgb(89, 89, 89)", fontSize: "11pt" }}>
                  ) you will not use the Services for any illegal or <div />
                  unauthorized
          ...
          <div style={{ textAlign: "left" }}>
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                your purchases and any applicable shipping fees, and you <div />
                authorize
          ...
          <div style={{ textAlign: "left" }}>
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                right to limit or prohibit orders that, in our sole <div />
                judgment
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              <span style={{ fontSize: 15 }}>
                ...
                your account.
                <div /> Your cancellation will take effect at the end of the
                current paid term.
              </span>
            </div>
            <div style={{ lineHeight: "1.5" }}>
            ...
            <div style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: 15 }}>
                ...
                <div>kacperadach@gmail.com</div>
                <div /> or call us at <div>5084797841</div>
                <div className="statement-end-if-in-editor" />.
                <div className="statement-end-if-in-editor" />
              </span>
            </div>
            ...
            <div style={{ textAlign: "justify", lineHeight: 1 }}>
              <div style={{ lineHeight: "1.5", textAlign: "left" }}>
                ...
                >
                  ...
                  <div />
                  endeavors
                  <div className="statement-end-if-in-editor" /> except those
            ...
            <div style={{ textAlign: "justify", lineHeight: 1 }}>
              <div style={{ lineHeight: "17.25px" }}>
                <div style={{ lineHeight: "1.1" }}>
                  ...
                  <ul>
                    <li style={{ lineHeight: "1.5", textAlign: "left" }}>
                      <span
                        style={{
                          fontSize: "11pt",
                          lineHeight: "16.8667px",
                            ...
                            >
                              <div data-type="conditional-block">
                                ...
                                >
                                  ...
                                  post content.
                                  <div /> We may provide you with the
                                  ...
                                  websites.
                                  <div /> As such, any Contributions you
                                  transmit may be treated in accordance with the
                ...
                <ul style={{ fontSize: "medium", textAlign: "left" }}>
                  ...
                  <li style={{ lineHeight: "1.5" }}>
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <span style={{ fontSize: 14 }}>
                        <span>
                          Your Contributions are not unsolicited or <div />
                          unauthorized
                          <div className="statement-end-if-in-editor" />{" "}
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              >
                ...
                >
                  ...
                  <div /> following the terms of the Privacy Policy
                  <div className="statement-end-if-in-editor" /> and your
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            >
              The Services may contain (or you may be sent via the <div />
              Site
              <div />) links to other websites (
              <div />
              "Third-Party Websites"
              <div className="statement-end-if-in-editor" />) as well as
            ...
            >
              ...
              <strong>
                ...
                <span style={{ color: "rgb(0, 58, 250)" }}>
                  ...
                  >
                    <a
                      href="http://www.AutoRepurpose.com/privacy-policy"
                      target="_blank"
                      data-custom-class="link"
                    >
                      http://www.AutoRepurpose.com/privacy-policy
                    </a>
                  </div>
                </span>
              </strong>
              ...
              advised the Services are hosted in <div />
              the <div>United States</div>
              <div />
              <div />. If you access the Services from any other region of the
              ...
              <div />, then through your continued use of the Services, you are
              ...
              <div />, and you expressly consent to have your data transferred
              to and processed in{" "}
              <span
                style={{
                  fontSize: "11pt",
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            ...
            >
              ...
              <div /> We will not be liable to you or any third party for any
            ...
            >
              ...
              >
                <div data-type="conditional-block">
                  ...
                  />
                  <div data-type="body">
                    the Commonwealth of <div>Massachusetts</div>
                    <div />
                  </div>{" "}
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            <span style={{ fontSize: 15 }}>
              ...
              controversy, or claim related to these Legal Terms (each a <div />
              "Dispute" and collectively, the "Disputes"
              <div className="statement-end-if-in-editor" />) brought by either
              you or us (individually, a <div />
              ...
              least <div>thirty (30)</div> days before initiating arbitration.
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            ...
            <span style={{ fontSize: 15 }}>
              ...
              arbitration will take place in <div />
              <div>Middlesex</div>,{" "}
              <div className="statement-end-if-in-editor" />
              <div />
              <div>Massachusetts</div>
              <div className="statement-end-if-in-editor" />. Except as
              ...
              confirm, modify, vacate, or enter <div />
              judgment
              <div className="statement-end-if-in-editor" /> on the award
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            ...
            <div style={{ fontSize: 15 }} /> <div>Middlesex</div>
            ...
            />{" "}
            <div style={{ fontSize: 15 }} />
            <div style={{ fontSize: 15 }}>Massachusetts</div>
            <div
              className="statement-end-if-in-editor"
              style={{ fontSize: 15 }}
            />
            <span style={{ fontSize: 15 }}>
              , and the Parties hereby consent to, and waive all <div />
              defenses
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            <span style={{ fontSize: 15 }}>
              ...
              any way to the Services be commenced more than <div>
                one (1)
              </div>{" "}
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            ...
            arbitrated on a class-action basis or to <div />
            utilize
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            ...
            of theft, piracy, invasion of privacy, or <div />
            unauthorized
            <div className="statement-end-if-in-editor" /> use; and (c) any
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            ...
            >
              ...
              <div />
              JUDGMENT
              <div className="statement-end-if-in-editor" /> AND EXERCISE
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            ...
            >
              ...
              >
                ...
                <div />
                defense
                <div className="statement-end-if-in-editor" /> and control of
                any matter for which you are required to indemnify us, and you
                agree to cooperate, at your expense, with our <div />
                defense
                <div className="statement-end-if-in-editor" /> of such claims.
          ...
          <div style={{ lineHeight: "1.5", textAlign: "left" }}>
            ...
            >
              ...
              and all <div />
              defenses
              <div className="statement-end-if-in-editor" /> you may have based
